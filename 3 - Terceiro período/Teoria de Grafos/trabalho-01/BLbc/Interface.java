...
public class Interface extends JFrame implements MouseListener{
    ...
    private final JLabel lbTitulo, lbComando, lbResultado, lbResultado2, lbInicio, lbFim;
    ...
    public Interface() {
        ...
        lbTitulo.setText("Busca em largura com backtracking e número de caminhos");
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (grafo.validade(campo, linhas)){
            ...
            grafo.setPrimeiro(vertice[cbInicio.getSelectedIndex()]);
            grafo.setUltimo(vertice[cbFim.getSelectedIndex()]);
            
            //exibe o resultado no campo da interface
            lbResultado.setText(grafo.mostraCaminhoMaisCurto(grafo.getPrimeiro(), grafo.getUltimo()));
            lbResultado2.setText(grafo.obterCaminhosMaisCurtos(grafo.getPrimeiro(), grafo.getUltimo()));
        }
        else {
